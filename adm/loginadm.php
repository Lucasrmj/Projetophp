...
<body>
    ...
    <form action="verificar.php" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" name="login" aria-describedby="emailHelp" placeholder="Login" required>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12" id="password-box">
        ...
        <button type="submit" id="buttom">Avançar</button>
      </form>
    </div>
