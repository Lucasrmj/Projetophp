...
<body>
                    ...
                    <ul class="navbar-nav ms-auto">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                          ...
                          <li><a class="dropdown-item" href="adm/loginadm.php" id="palavras2">ADM</a></li>
        ...
        <main>
            <div class="conteudo">
                <h1>Bem-Vindo ao Rebook</h1>
                <p>sua porta de entrada para uma leitura envolvente e sustentável, onde cada página vira um passo em direção a um futuro mais verde. </p>
            </div>
  </main>
